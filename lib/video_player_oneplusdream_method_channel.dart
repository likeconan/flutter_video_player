...
class MethodChannelVideoPlayerOneplusdream
  ...
  Future<void> init(int videoId) {
    ...
    print('create channel with $videoId $channel');
    ...
    try {
      switch (call.method) {
        ...
        case ON_PLAYING:
          ...
          break;
        case ON_RATE_CHANGE:
          _videoEventStreamController.add(RateChangeEvent(id, call.arguments));
          break;
        case ON_URL_REQUESTED:
          _videoEventStreamController
              .add(UrlRequestedEvent(id, call.arguments));
          break;
        default:
  ...
  @override
  Stream<RateChangeEvent> onRateChange({required int videoId}) {
    return _events(videoId).whereType<RateChangeEvent>();
  }

  @override
  Stream<UrlRequestedEvent> onUrlRequested({required int videoId}) {
    return _events(videoId).whereType<UrlRequestedEvent>();
  }
