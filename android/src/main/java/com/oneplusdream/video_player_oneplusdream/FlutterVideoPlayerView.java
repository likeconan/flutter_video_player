...
class FlutterVideoPlayerView extends PlatformViewFactory implements MethodChannel.MethodCallHandler {
    ...
    public PlatformView create(@NonNull Context context, int id, @Nullable Object args) {
        ...
        Integer creationId = (Integer) creationParams.get("creationId");
        MethodChannel channel = new MethodChannel(_flutterPluginBinding.getBinaryMessenger(), "oneplusdream/video_channel_" + creationId);
